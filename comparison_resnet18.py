...
def train_task(task, run_suffix, device):
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler(os.path.join(task_dir, f'training_{task}_ResNet18.log'))
        ]
    )
    ...
    for epoch, i in enumerate(range(1, num_epochs + 1), 1):
        ...
        if val_loss < best_val_loss:
            ...
            val_model_path = os.path.join(task_dir, f'best_model_val_ResNet18.pth')
        ...
        if test_loss < best_test_loss:
            ...
            test_model_path = os.path.join(task_dir, f'best_model_test_ResNet18.pth')
    ...
    val_model_path = os.path.join(task_dir, 'best_model_val_ResNet18.pth')
    ...
    test_model_path = os.path.join(task_dir, 'best_model_test_ResNet18.pth')
